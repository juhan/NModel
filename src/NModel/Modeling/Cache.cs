...
{
    ///// <summary>
    ///// Generic object cache that caches the result of a variable list of arguments.
    ///// </summary>
    ///// <typeparam name="T">Type of object to cache.</typeparam>
    //internal abstract class Cache<T>
    //{
    //    private Dictionary<object/*?*/[], T> cache = new Dictionary<object/*?*/[], T>(ArrayEqualityComparer<object/*?*/>.Default);

    //    protected T Get(params object/*?*/[] args)
    //    {
    //        T value;
    //        if (!cache.TryGetValue(args, out value))
    //            cache[args] = value = Compute(args);
    //        return value;
    //    }
    ...
    //internal class Cache<T, A> : Cache<T>
    //{
    //    public delegate T Computer(A arg);
    //    private Computer compute;
    //    public Cache(Computer computer) { compute = computer; }
    ...
    //internal class Cache<T, A1, A2> : Cache<T>
    //{
    ...
    //[SuppressMessage("Microsoft.Design", "CA1005:AvoidExcessiveParametersOnGenericTypes")]
    //internal class Cache<T, A1, A2, A3> : Cache<T>
    //{
    ...
    //[SuppressMessage("Microsoft.Design", "CA1005:AvoidExcessiveParametersOnGenericTypes")]
    //internal class Cache<T, A1, A2, A3, A4> : Cache<T>
    //{
    ...
    //[SuppressMessage("Microsoft.Design", "CA1005:AvoidExcessiveParametersOnGenericTypes")]
    //internal class Cache<T, A1, A2, A3, A4, A5> : Cache<T>
    //{
    ...
    //[SuppressMessage("Microsoft.Design", "CA1005:AvoidExcessiveParametersOnGenericTypes")]
    //internal class Cache<T, A1, A2, A3, A4, A5, A6> : Cache<T>
    //{
    ...
    //[SuppressMessage("Microsoft.Design", "CA1005:AvoidExcessiveParametersOnGenericTypes")]
    //internal class Cache<T, A1, A2, A3, A4, A5, A6, A7> : Cache<T>
    //{
    ...
    //[SuppressMessage("Microsoft.Design", "CA1005:AvoidExcessiveParametersOnGenericTypes")]
    //internal class Cache<T, A1, A2, A3, A4, A5, A6, A7, A8> : Cache<T>
    //{
    ...
    //[SuppressMessage("Microsoft.Design", "CA1005:AvoidExcessiveParametersOnGenericTypes")]
    //internal class Cache<T, A1, A2, A3, A4, A5, A6, A7, A8, A9> : Cache<T>
    //{
