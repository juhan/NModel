...
namespace WinFormUnitDrive
{
    public class UnitDrive
    {
        ...
        private static UnitDrive m_unitDriveInstance = null;
        private string m_formName;
        private string m_implPath;
        Form m_form = null;
        
        public static UnitDrive getUnitDrive(string formName, string implPath)
        {
            if (m_unitDriveInstance == null)            
                m_unitDriveInstance = new UnitDrive(formName, implPath);
            return m_unitDriveInstance;
        }

        private UnitDrive(string formName, string implPath)
        {
            m_formName = formName;
            m_implPath = implPath;            
        }
