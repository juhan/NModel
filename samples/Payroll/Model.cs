...
namespace Payroll
{
  ...
  //      static Set<Employee> NextEmployee() {
  //        return new Set<Employee>(nextId == 1 ? Employee.E1 : Employee.E2);
          
  //        // return new Set<Employee>(new Employee(nextId)); 
  //      }
